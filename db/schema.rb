...
ActiveRecord::Schema.define(version: 20_160_813_165_954) do
  ...
  create_table 'auth_tokens', force: :cascade do |t|
    ...
    t.index %w(authenticatable_type authenticatable_id), name: 'authenticatable_id_type_idx', using: :btree
